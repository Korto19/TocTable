...
from .TocTable_algorithm import TocTableAlgorithm
...
class TocTableProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(TocTableAlgorithm())
